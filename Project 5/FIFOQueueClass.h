...
// The first-in-first-out (FIFO) queue data struture is implemented using the
// LinkedNodeClass described above.
template < class T >
class FIFOQueueClass
{
    ...
    public:
        // Default constructor. Will properly initialize a queue to be an
        // empty queue, to which values can be added.
        FIFOQueueClass();
